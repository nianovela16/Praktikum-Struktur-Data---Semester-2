...
struct identitasMhs_057 {
    string nama;
    string nim;
    identitasMhs_057* next;
};

class LinkedList {
private:
    identitasMhs_057* head;
...
public:
    ...
    void addFirst(string nama, string nim) {
        identitasMhs_057* newNode = new identitasMhs_057();
        newNode->nama = nama;
        newNode->nim = nim;
        newNode->next = head;
        head = newNode;
    ...
    void deleteMiddle(int posisi) {
        ...
        identitasMhs_057* nextNode = temp->next->next;
        delete temp->next;
        temp->next = nextNode;
        cout << endl << "Data di posisi " << posisi << " telah dihapus"<<endl;
    }
